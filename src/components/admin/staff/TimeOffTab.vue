<template>
  <b-row v-show="currentStaff" class="mb-2">
    ...
    <b-col cols="10">
      ...
      <template v-if="currentStaff && currentStaff.timeoffs.length > 0">
...
export default {
  ...
  methods: {
    ...mapActions({
      createStaffTimeOff: 'createStaffTimeOff',
      updateStaffTimeOff: 'updateStaffTimeOff',
      deleteStaffTimeOff: 'deleteStaffTimeOff',
    }),
    showModal() {
