...
export default {
  ...
  computed: {
    ...
    staffActiveService() {
      return this.currentStaff && this.currentStaff.userservices && this.currentStaff.userservices.services.length || 0
    },
    activeServices() {
      let services = []
      services = this.currentStaff && this.currentStaff.userservices && this.currentStaff.userservices.services
      return services
    }
  },
  mounted() {
  ...
  methods: {
    ...mapActions({
      createSelfStaffService: 'createSelfStaffService',
    }),
    formGen() {
      this.form.services = this.currentStaff && this.currentStaff.userservices && this.currentStaff.userservices.services
    },
    handleChange() {
      this.createSelfStaffService(this.form)
    }
  },
  watch: {
