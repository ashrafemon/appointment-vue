<template>
  <div class="py-4">
    <div class="container">
      <b-row class="mb-2">
        <b-col v-if="currentStaff" cols="10">
...
export default {
  ...
  methods: {
    ...mapActions({
      createSelfStaffBreakTime: 'createSelfStaffBreakTime',
      updateSelfStaffBreakTime: 'updateSelfStaffBreakTime',
      deleteSelfStaffBreakTime: 'deleteSelfStaffBreakTime',
    }),
    resetAllDay() {
      this.breakTimes = {
        monday: [],
    ...
    startTimeChange(dayName, value) {
      ...
      if (Object.keys(this.breakTimeForm[dayName.toLowerCase()]).length === 3) {
        this.createSelfStaffBreakTime(this.breakTimeForm[dayName.toLowerCase()]);
      }
    },
    ...
    deleteBreakTime(id) {
      this.$swal({
        ...
        if (result.isConfirmed) {
          this.deleteSelfStaffBreakTime(id);
        }
      })
    },
  }
